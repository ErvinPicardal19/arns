...
def generate_launch_description():
   ...
   arns_slam_pkg = get_package_share_directory("arns_slam")
   ...
   declare_map_file = DeclareLaunchArgument(
      name="map",
      default_value=os.path.join(arns_slam_pkg, "maps/simulation_map.yaml"),
   ...
   start_amcl = IncludeLaunchDescription(
      PythonLaunchDescriptionSource([
         os.path.join(arns_slam_pkg, "launch/localization_launch.py")
      ]),
   ...
   start_navigation = IncludeLaunchDescription(
      PythonLaunchDescriptionSource([
         os.path.join(arns_navigation_pkg, "launch/navigation_launch.py")
      ]),
